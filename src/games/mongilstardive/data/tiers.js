...
export const tieredMaterials = {
  sinew: {
    1: { name: 'sinew_t1', game_id: 8120010001, synthesizable: { to: 2, count: 3 } },
    2: { name: 'sinew_t2', game_id: 8120010002, synthesizable: { to: 3, count: 3 } },
    3: { name: 'sinew_t3', game_id: 8120010003, synthesizable: { to: 4, count: 3 } },
    4: { name: 'sinew_t4', game_id: 8120010004, synthesizable: { to: 5, count: 3 } },
    5: { name: 'sinew_t5', game_id: 8120010005 },
  },
  cartilage: {
    1: { name: 'cartilage_t1', game_id: 8120020001, synthesizable: { to: 2, count: 3 } },
    2: { name: 'cartilage_t2', game_id: 8120020002, synthesizable: { to: 3, count: 3 } },
    3: { name: 'cartilage_t3', game_id: 8120020003, synthesizable: { to: 4, count: 3 } },
    4: { name: 'cartilage_t4', game_id: 8120020004, synthesizable: { to: 5, count: 3 } },
    5: { name: 'cartilage_t5', game_id: 8120020005 },
  },
  fur: {
    1: { name: 'fur_t1', game_id: 8120030001, synthesizable: { to: 2, count: 3 } },
    2: { name: 'fur_t2', game_id: 8120030002, synthesizable: { to: 3, count: 3 } },
    3: { name: 'fur_t3', game_id: 8120030003, synthesizable: { to: 4, count: 3 } },
    4: { name: 'fur_t4', game_id: 8120030004, synthesizable: { to: 5, count: 3 } },
    5: { name: 'fur_t5', game_id: 8120030005 },
  },
  powder: {
    1: { name: 'powder_t1', game_id: 8120040001, synthesizable: { to: 2, count: 3 } },
    2: { name: 'powder_t2', game_id: 8120040002, synthesizable: { to: 3, count: 3 } },
    3: { name: 'powder_t3', game_id: 8120040003, synthesizable: { to: 4, count: 3 } },
    4: { name: 'powder_t4', game_id: 8120040004, synthesizable: { to: 5, count: 3 } },
    5: { name: 'powder_t5', game_id: 8120040005 },
  },
  carapace: {
    1: { name: 'carapace_t1', game_id: 8120050001, synthesizable: { to: 2, count: 3 } },
    2: { name: 'carapace_t2', game_id: 8120050002, synthesizable: { to: 3, count: 3 } },
    3: { name: 'carapace_t3', game_id: 8120050003, synthesizable: { to: 4, count: 3 } },
    4: { name: 'carapace_t4', game_id: 8120050004, synthesizable: { to: 5, count: 3 } },
    5: { name: 'carapace_t5', game_id: 8120050005 },
  },
