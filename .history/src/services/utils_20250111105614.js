...
export const setGradientStyle = (character, isBorder = false) => {
  ...
  if (!isBorder) {
    if (character.element) {
      ...
      return {
        ...
        backgroundImage: `linear-gradient(180deg, ${rarityColors[character.rarity]} 40%, #FFFFFF 1%) `,
      };
    }
  }
    ...
    if (character.element) {
      return {
        backgroundImage: `linear-gradient(180deg, ${rarityColors[character.rarity]} 40%, ${elementColors[character.element]} 59%)`,
      ...
      return {
        backgroundImage: `linear-gradient(180deg, ${rarityColors[character.rarity]} 40%)`,
        border: '5px solid transparent',
        backgroundClip: 'padding-box',
      };
    }
