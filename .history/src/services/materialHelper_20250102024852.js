    ...
    synthesizableTypes.forEach((type) => {
        ...
        for (let i = 0; i < materials.length - 1; i++) {
            ...
            if (synthesizableQty > 0) {
                ...
                updatedNeeds[nextMaterial.game_id] = (updatedNeeds[nextMaterial.game_id] || 0) + synthesizableQty;  // 다음 재료의 필요량 증가
                inventory[nextMaterial.game_id] = (inventory[nextMaterial.game_id] || 0) + synthesizableQty;  // 다음 재료의 보유량 증가
