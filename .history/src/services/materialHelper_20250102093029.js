...
export const calculateMaterials = (inventory, tieredMaterials, shortages) => {
    ...
    if (!forwardResult || !forwardResult.synthesisResults) {
        console.error("[Error] Forward synthesis returned invalid results.");
    ...
    if (!finalNeeds || typeof finalNeeds !== 'object') {
        console.error("[Error] Backward Conversion returned invalid results.");
        return { final_inventory: {}, synthesis_results: {}, final_needs: {} };
    }
