...
import { saveGoalsToDrive, loadGoalsFromDrive } from '../services/googleAuth.js';
...
export const usePlannerStore = defineStore('planner', {
  ...
  actions: {
    ...
    // Google Drive 연동 부분
    async saveGoals() {
      await saveGoalsToDrive(this.goals);
    },

    async loadGoals(fileId)
    {
      this.goals = await loadGoalsFromDrive(fileId);
    }
  },
});
