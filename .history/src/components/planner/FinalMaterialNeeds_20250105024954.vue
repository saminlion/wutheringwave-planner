...
const totalExpNeed = (category) => {
    ...
    Object.entries(category.subCategories).forEach(([subcategoryName, subcategoryData]) => {
        ...
        console.log(`[Debug] Missing Total Exp 2: ${missingTotalExp} / Missing Cal Exp 2: ${missingCalExp} / Current Total Exp 2: ${currentTotalExp}`);
