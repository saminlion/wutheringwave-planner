                ...
                <div class="subcategory-list">
                    ...
                    <div class="subcategory-card" v-for="(subCategory, subCategoryName) in category.subCategories"
                        ...
                        <div class="estimate-container">
                            <p>예상 런 횟수: {{ esimatedRun.value({
                                name: category.name, subcategory: subCategory.id,
                                subCategories: { [subCategory.id]: subCategory }
                            }) }}</p>
                            <p>예상 레진 소모: {{ esimatedResin.value({
                                name: category.name, subcategory: subCategory.id,
                                subCategories: { [subCategory.id]: subCategory }}) }}</p>
                            <p v-if="subCategory.name !== 'weeklyboss'">예상 완료 시간: <span class="font-semibold">{{
                                esimatedDate.value({
                                    name: category.name, subcategory: subCategory.id,
                                    subCategories: { [subCategory.id]: subCategory }}) }}일</span></p>
                            <p v-else>예상 완료 시간: <span class="font-semibold">{{ esimatedDate.value({
                                name: category.name,
                                subcategory: subCategory.id, subCategories: { [subCategory.id]: subCategory }})
                                    }}주</span></p>
                        </div>
