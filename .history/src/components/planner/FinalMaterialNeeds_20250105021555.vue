                            ...
                            <li class="material-card" >
                                <div class="material-info">
                                    ...
                                    <template v-if="task.id === 'player_exp' || task.id === 'weapon_exp'">
                                        <div v-for="(expDetails, id) in player_exp_material" :key="id">
                                            <img v-if="getMaterialIcon(id)" :src="getMaterialIcon(id)"
                                                alt="material icon" class="material-icon" />
                                            <span class="material-quantity">보유: {{
                                                inventoryStore.getMaterialQuantity(id) }}</span>
                                            <span class="material-quantity" v-if="task.need && task.need > 0">필요: {{
                                                task.need }}</span>
                                        </div>
                                    </template>
                                    ...
                                    <template
                                        ...
                                        <img v-if="getMaterialIcon(task.id)" :src="getMaterialIcon(task.id)" alt="material icon"
                                        class="material-icon" />
