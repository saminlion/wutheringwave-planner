                                ...
                                <li class="material-card" v-for="(expDetails, id) in player_exp_material" :key="id">
                                    <div class="material-info">
                                        ...
                                        <div class="material-quantity-container">
                                            <!-- 필요 뱃지 -->
                                            <span class="badge badge-need" v-if="expDetails.need > 0">
                                                필요: {{ expDetails.need }}
                                            </span>
                                            <!-- 합성 뱃지 -->
                                            ...
                                            <input class="material-quantity-input" type="number"
                                                v-model="inventoryStore.getMaterialQuantity(id)"
                                                @change="updateInventory(id)" />
                                        </div>
                                    </div>
                                </li>
                            </template>
                                ...
                                <li class="material-card" v-for="task in subCategory.task" :key="task.id">
                                    <div class="material-info">
                                        ...
                                        <div class="material-quantity-container">
                                            ...
                                            <!-- 보유 입력 -->
                                            <input class="material-quantity-input" type="number"
                                                v-model="inventoryStore.getMaterialQuantity(task.id)"
                                                @change="updateInventory(task.id)" />
                                        </div>
                                    </div>
                                </li>
                            </template>
...
const updateInventory = (id) => {
    const quantity = inventoryStore.getMaterialQuantity(id);
    inventoryStore.updateMaterialQuantity(id, quantity);
};
