                                ...
                                <li class="material-card" v-for="task in subCategory.task" :key="task.id">
                                    <div class="material-info">
                                        ...
                                        <div class="material-quantity-container">
                                            ...
                                            <!-- 보유 입력 -->
                                            <input class="material-quantity-input" type="number"
                                                :value="getMaterialQuantity(task.id)"
...
const categorizedMaterials = computed(() => {
  ...
  return groupMaterialsByCategoryAndSubCategory(props.materials);
});
...
watch(
  () => props.materials,
  (newVal) => {
    console.log("[Debug] Props materials updated:", newVal);
  },
  { deep: true }
);
