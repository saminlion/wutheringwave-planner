    ...
    <div class="final-material-needs">
        ...
        <div class="final-container">
            <div class="category-card" v-for="(category, categoryName) in categorizedMaterials" :key="categoryName">
                ...
                <div class="subcategory-card" v-for="(subCategory, subCategoryName) in category.subCategories" :key="subCategoryName">
                ...
                <div class="estimate-container">
                    ...
                    <p v-if="subCategory.name !== 'weeklyboss'">예상 완료 시간: <span class="font-semibold">{{
                        esimatedDate(subCategory) }}일</span></p>
                    <p v-else>예상 완료 시간: <span class="font-semibold">{{ esimatedDate(subCategory) }}주</span></p>
                </div>
...
const CalculateEstimatedRun = (data) => {
    ...
    Object.entries(data.subCategories).forEach(([subcategoryName, subcategoryData]) => {
        // console.log(`[Debug] subcategory: ${subcategoryName}`);
        // console.log(`[Debug] subcategoryData: ${JSON.stringify(subcategoryData)}`);
...
.subcategory-card {
    flex: 1 1 calc(33.33% - 16px); /* 3개의 카드가 한 행에 나열 */
