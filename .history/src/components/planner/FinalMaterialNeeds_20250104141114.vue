...
const groupMaterialsByCategoryAndSubCategory = (materials) => {
    ...
    Object.entries(materials).forEach(([mat, qty]) => {
        console.log(`[Debug] Get material: ${mat} / quantity: ${qty}`);

    });

    materials.forEach((item, index) => {
  console.log(`[Debug] Get material 2: ${index} / quantity: ${item}`);
});


//     const grouped = materials.reduce((acc, material) => {

//        // console.log(`[Debug] Get material: ${JSON.stringify(material)}`);
...
//    // console.log(`[Debug] Get CategorizedMaterials: ${JSON.stringify(grouped)}`);
...
onMounted(() => {
    ...
    console.log(`[Debug] Get material: ${JSON.stringify(props.materials)}`);
