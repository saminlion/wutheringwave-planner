            ...
            if (categoryName === "forgery" || categoryName === "common") {
                ...
                subcategoryData.task.forEach((task) => {
                    ...
                    Object.entries(player_exp_material).forEach(([id, exp])=>{
                        ...
                        console.log(`[Debug] Data Check qty: ${inventory.getMaterialQuantity(id)}`);
                        
                    });


//     for(const item of player_exp_material)
                // {
                //     console.log(`[Debug] Data Check item: ${item}`);

                // }
                   
                });

                //calculatePlayerExp(expNeeded, player_exp_material, ownedMaterials)
