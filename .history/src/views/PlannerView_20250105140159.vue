<template>
  <div>
    ...
    <FinalMaterialNeeds :materials="finalMaterialNeeds" @updateInventory="handleInventoryUpdate" />
  </div>
</template>
...
watch(
  () => finalMaterialNeeds.value,
  (newValue) => {
    console.log("[Debug] Inventory updated. Recalculating...", newValue);
