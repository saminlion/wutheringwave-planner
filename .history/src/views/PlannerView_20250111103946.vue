    ...
    <div>
      ...
      <div class="goals-container">
        <div class="goal-border" v-for="goal in goals" :key="goal.name"
          :class="{ hidden: goal.hidden }"
          :style="setGradientStyle(getRawData(goal.id), true)">
          <div class="goal-card">
            <!-- 캐릭터 이름과 아이콘 -->
            <div class="goal-header">
              <div :class="['character-container', { hidden: goal.hidden && String(goal.id).startsWith('42') }]"
              ...
              <div :class="['weapon-container', { hidden: goal.hidden && !String(goal.id).startsWith('42') }]" v-else>
