        ...
        <div class="goal-border" v-for="goal in goals" :key="goal.name"
          ...
          <div class="goal-card">
            ...
            <div class="goal-header">
              <div :class="['character-container', { hidden: isHidden && String(goal.id).startsWith('42') }]"
              ...
              <div :class="['weapon-container', { hidden: isHidden && !String(goal.id).startsWith('42') }]" v-else>
