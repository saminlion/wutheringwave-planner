...
<ChracterDialog  v-if="dialogVisible && selectedCharacter" :visible="dialogVisible" :character="selectedCharacter"
      ...
      <WeaponDialog v-if="dialogVisible && selectedweapon" :visible="dialogVisible" :weapon="selectedweapon"
        :settings="currentSettings" :levelItems="levelItems"
...
import { levelItems } from '../data/formweaponsNew';
