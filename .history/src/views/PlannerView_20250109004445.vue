...
.icon-container {
  display: flex; /* 아이콘 정렬을 위한 플렉스 박스 */
  align-items: center; /* 세로 중앙 정렬 */
  justify-content: flex-start; /* 왼쪽 정렬 (원하는 경우 center로 변경 가능) */
  flex-wrap: nowrap; /* 한 줄로 강제 정렬 */
  gap: 8px; /* 아이콘 간격 */
}
